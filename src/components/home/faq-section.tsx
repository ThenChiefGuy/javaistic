...
const FAQ_ITEMS: FAQItem[] = [
  {
    question: "Is HabibiJava really free?",
    answer:
      "Yes! HabibiJava is completely free and always will be. We believe quality programming education should be accessible to everyone, regardless of their financial situation. No premium tiers, no hidden costs, no paywalls.",
  },
  {
  ...
  {
    question: "What makes HabibiJava different from other learning platforms?",
    answer:
      "HabibiJava is specifically focused on Java programming with hands-on, practical examples. Unlike generic coding platforms, we provide deep, comprehensive Java education that's completely free and community-driven. Our content is created by experienced Java developers for real-world application.",
  },
  {
    question: "How can I contribute to HabibiJava?",
    answer: "We welcome contributions from everyone! You can help by writing tutorials, fixing bugs, improving documentation, translating content, or spreading the word. Visit our GitHub repository to see open issues, submit pull requests, or join our contributor community.",
  },
  {
  ...
  {
    question: "Can I use HabibiJava content for teaching?",
    answer:
